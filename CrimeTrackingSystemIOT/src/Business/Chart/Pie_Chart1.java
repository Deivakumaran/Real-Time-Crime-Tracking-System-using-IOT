 ...
 * @author deivakumaran
 */
public class Pie_Chart1 extends JPanel {
    ...
    public Pie_Chart1(String title, Enterprise enterprise, CommissionerOrganization organization, String reportType, String startAge, String endAge) {
    ...
    public void main(String reportType, String startAge, String endAge) {
        JFrame frame = new JFrame("Number of Crime in Massachusetts");
        Pie_Chart1 chart = new Pie_Chart1("", enterprise, commissionerOrganization, reportType, startAge, endAge);
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            ...
            if (organization.getName().equalsIgnoreCase(Organization.Type.Admin.getValue())) {
                ...
                for (Criminal criminal : admin.getCriminalDirectory().getCriminalList()) {
                    ...
                    if (criminal.getAge() > Integer.parseInt(startAge) && criminal.getAge() < Integer.parseInt(endAge)) {

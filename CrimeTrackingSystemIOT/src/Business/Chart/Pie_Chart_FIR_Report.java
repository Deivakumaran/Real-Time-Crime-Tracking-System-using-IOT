 ...
 * @author deivakumaran
 */
public class Pie_Chart_FIR_Report extends ApplicationFrame {
    ...
    public Pie_Chart_FIR_Report(String title, Enterprise enterprise, CommissionerOrganization organization) {
        super(title);
